...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-230, -690, -1, -1));
        ...
        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/update_1.png"))); // NOI18N
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        ...
        if(open == 0){
            ...
            JFrame jf = new JFrame();
            jf.setAlwaysOnTop(true);
            JOptionPane.showMessageDialog(jf, "At a time only one form can be opened");
        }
